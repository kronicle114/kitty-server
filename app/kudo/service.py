## service class will translate incoming request payload to our schema, that way the object persist in our database
...
class Service(object):
  def __init__(self, name, age):
    ...
    if not name:
      raise Exception("kitty name is not provided")
  
  def create_kitty(self):
    KittySchema(self.name, self.age)
